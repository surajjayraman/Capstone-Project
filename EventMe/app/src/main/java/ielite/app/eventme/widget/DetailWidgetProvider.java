...
import ielite.app.eventme.DetailActivity;
...
public class DetailWidgetProvider extends AppWidgetProvider {
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        // updated. If the data is too old, the service will update it using EventMeService.
    ...
    public void onReceive(@NonNull Context context, @NonNull Intent intent) {
        ...
        if (EventMeService.ACTION_DATA_UPDATED.equals(intent.getAction())) {
    ...
    private void setRemoteAdapter(Context context, @NonNull final RemoteViews views) {
        views.setRemoteAdapter(R.id.widget_list,
                new Intent(context, ielite.app.eventme.widget.DetailWidgetRemoteViewsService.class));
    }
