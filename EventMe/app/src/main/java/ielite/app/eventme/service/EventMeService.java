...
import ielite.app.eventme.MainActivity;
import ielite.app.eventme.R;
import ielite.app.eventme.data.CategoriesAndRegionsColumns;
import ielite.app.eventme.data.EventProvider;
import ielite.app.eventme.data.RegionsColumns;
 ...
 */
public class EventMeService extends IntentService {
    public static final String ACTION_DATA_UPDATED =
            "ielite.app.eventme.ACTION_DATA_UPDATED";
    ...
    private static final String LOG_TAG = EventMeService.class.getSimpleName();

    public EventMeService() {
        super("EventMe");
    }
    ...
    private void addContentValuesToDB(int dataType, ContentValues[] contentValues) {
        ...
        if (contentUri.getPath() == null) {
            throw new IllegalArgumentException("Data type must be one of the three listed in " +
                    "EventMeService.REQUIRED_CONTENT_VALUES");
        } else {
